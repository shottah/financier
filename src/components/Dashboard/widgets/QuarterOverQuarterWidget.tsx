            ...
            <div className="space-y-3">
              {trends.slice(0, 3).map((trend, index) => (
                <div key={trend.category} className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <h4 className="text-xs font-medium">QoQ Change</h4>
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Last Q: ${(trend.totalLastQuarter/1000).toFixed(0)}k</span>
                    <span>Current Q: ${(trend.totalCurrentQuarter/1000).toFixed(0)}k</span>
                  </div>
